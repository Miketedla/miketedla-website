    ...
    <section className="bg-[var(--background)] text-[#F2EFE9]">
      <div className="mx-auto max-w-5xl px-6 py-32 text-center md:py-48">
        ...
        <a
          ...
          className="mt-10 inline-block border-b border-transparent text-3xl font-light text-[#F2EFE9] transition-all duration-300 hover:border-[#F2EFE9] hover:text-white cursor-pointer md:text-5xl"
        >
