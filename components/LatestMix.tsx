...
export default function LatestMix() {
    ...
    <section className="bg-[#080808] text-[#F2EFE9]">
      <div className="mx-auto max-w-6xl px-6 py-24 md:px-8 md:py-40">
        ...
        <a
          ...
          className="group mx-auto mt-10 block max-w-3xl"
        >
  ...
  <div className="absolute inset-0 flex items-center justify-center">
    ...
    <div className="flex flex-col items-center">
      ...
      <span className="text-sm uppercase tracking-[0.55em] text-white transition-all duration-300 group-hover:tracking-[0.45em]">
        Lyssna
      </span>
